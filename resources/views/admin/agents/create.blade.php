        ...
        <div class="p-6">
            <div class="mb-6">
                <div class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-2">
                    ...
                    <a href="{{ route('admin.agents.index') }}" class="hover:text-blue-600 dark:hover:text-blue-400">Agents</a>
                    <i class="fas fa-chevron-right text-xs"></i>
                    <span class="text-gray-900 dark:text-white">Create</span>
                </div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New Agent</h1>
            </div>
            ...
            <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md p-6 max-w-3xl">
                <form action="{{ route('admin.agents.store') }}" method="POST">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-4">
                        <a href="{{ route('admin.agents.index') }}" class="px-6 py-3 border border-gray-300 dark:border-slate-500 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-600 transition">
