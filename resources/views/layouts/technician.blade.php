    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="p-4 space-y-2">
            <a href="{{ route('technician.dashboard') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.dashboard') ? 'bg-slate-700 text-white' : '' }}">
                <i class="fas fa-home w-5 mr-3"></i><span>Dashboard</span>
            </a>
            <a href="{{ route('technician.tasks') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.tasks*') ? 'bg-slate-700 text-white' : '' }}">
                <i class="fas fa-tasks w-5 mr-3"></i><span>Tugas Saya</span>
            </a>
            <a href="{{ route('technician.installations') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.installations*') ? 'bg-slate-700 text-white' : '' }}">
                <i class="fas fa-plug w-5 mr-3"></i><span>Instalasi</span>
            </a>
            <a href="{{ route('technician.repairs') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.repairs*') ? 'bg-slate-700 text-white' : '' }}">
                <i class="fas fa-wrench w-5 mr-3"></i><span>Perbaikan</span>
            </a>
            <a href="{{ route('technician.map') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.map*') ? 'bg-slate-700 text-white' : '' }}">
                <i class="fas fa-map-marked-alt w-5 mr-3"></i><span>Peta Jaringan</span>
            </a>
            <a href="{{ route('technician.profile') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-slate-700 transition-colors {{ request()->routeIs('technician.profile*') ? 'bg-slate-700 text-white' : '' }}">
        ...
        <header class="bg-white dark:bg-slate-900 shadow-sm border-b border-gray-200 dark:border-slate-700 sticky top-0 z-30 transition-colors duration-300">
            <div class="flex items-center justify-between px-4 py-3">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <span class="text-gray-600 dark:text-gray-300">{{ Auth::user()->name ?? 'Technician' }}</span>
