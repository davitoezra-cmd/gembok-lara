...
@section('title', 'Tambah Modem Baru')
    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Perangkat Modem</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Dafrarkan aset modem baru ke dalam sistem</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md p-6 max-w-2xl">
                <form action="{{ route('admin.network.modems.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="nomor_aset_internal" id="nomor_aset_internal" value="{{ old('nomor_aset_internal') }}" placeholder="Contoh: GL-MDM-2026-001"
                        ...
                        <div>
                            ...
                            <input type="text" name="serial_number" id="serial_number" value="{{ old('serial_number') }}" placeholder="Masukkan SN resmi perangkat"
                        ...
                        <div>
                            ...
                            <input type="text" name="merek" id="merek" value="{{ old('merek') }}" placeholder="Contoh: Huawei, ZTE, FiberHome"
                        ...
                        <div>
                            ...
                            <select name="status" id="status" 
                                ...
                                <option value="stok_gudang" {{ old('status') == 'stok_gudang' ? 'selected' : '' }}>Stok Gudang</option>
                                <option value="terpasang" {{ old('status') == 'terpasang' ? 'selected' : '' }}>Terpasang (Aktif)</option>
