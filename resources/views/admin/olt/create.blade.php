        ...
        <div class="p-6">
            <div class="max-w-2xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah OLT</h1>
                        <p class="text-gray-600 dark:text-gray-400">Daftarkan perangkat OLT baru</p>
                    </div>
                    <a href="{{ route('admin.olt.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white">
                ...
                <div class="bg-white dark:bg-slate-700 rounded-xl shadow-sm border border-gray-100 dark:border-slate-600 p-6">
                    <form action="{{ route('admin.olt.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Total PON Ports</label>
                            ...
                            <div class="col-span-2 border-t pt-4 mt-2 dark:border-slate-600">
                                <h3 class="font-medium text-gray-800 dark:text-gray-200 mb-4">Telnet Configuration (Optional)</h3>
                            </div>
                        ...
                        <div class="flex justify-end space-x-3 mt-6 pt-6 border-t dark:border-slate-600">
                            <a href="{{ route('admin.olt.index') }}" class="px-4 py-2 border border-gray-300 dark:border-slate-500 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-600">Batal</a>
